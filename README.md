...
<li>PLANS (citizens can remember tasks involving multiple steps and even multiple citizens for the future)
...
<li>Gathering: This skill simply increases the looting that occurs when destroying blocks. Citizens with this skill destroy natural blocks to collect ores and wood and the like.
<li>Research: This skill allows the usage of the Research Table, which can be used to reverse engineer (show the recipes of) items. 
  <li></li>
 </ul>
