package com.gm910.occentmod.sapience.mind_and_traits.emotions;
...
public class Mood<E extends LivingEntity> {
	...
	public static final Mood<LivingEntity> HOBBY = new Mood<LivingEntity>(GMFiles.rl("hobby"), LivingEntity.class) {
		@Override
		public void affectLevels(Emotions emo) {
			if (emo.getTicksExisted() % 10 == 0)
				emo.changeLevel(EmotionType.FUN, 0.2f);
		}
	};
	...
	public void affectLevels(Emotions emot) {
	...
	public String toString() {
		...
		return this.getDisplayText().getFormattedText() + " for classes " + entityClass;
	}
