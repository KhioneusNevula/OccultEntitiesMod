...
public enum PersonalityTrait implements IStringSerializable {
	...
	public static enum TraitLevel {
		...
		public boolean isLessThan(TraitLevel than, boolean orEqual) {
			return orEqual ? this.id <= than.id : this.id < than.id;
		}

		public boolean isGreaterThan(TraitLevel than, boolean orEqual) {
			return orEqual ? this.id >= than.id : this.id > than.id;
		}
