...
public class MemoryOfBlockRegion<E extends LivingEntity> extends Memory<E> {
	...
	public MemoryOfBlockRegion(E owner, DimensionType dim, Pair<BlockPos, BlockState>... statesPoses) {
		super(owner, MemoryType.BLOCK_REGION);
		this.dim = dim;
		this.blocks.putAll(
	...
	public BlockState setDesiredState(BlockPos pos, BlockState state) {
		return this.blocks.put(pos, state);
	}
	...
	public void setDim(DimensionType dim) {
		this.dim = dim;
	}
