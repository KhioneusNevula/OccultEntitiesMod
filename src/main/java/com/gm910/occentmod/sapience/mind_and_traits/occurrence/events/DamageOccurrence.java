package com.gm910.occentmod.sapience.mind_and_traits.occurrence.events;
...
public class DamageOccurrence extends Occurrence {
	...
	public SapientIdentity getDoer() {
		return this.getTrueDamager() instanceof LivingEntity
				&& SapientInfo.isSapient((LivingEntity) this.getTrueDamager())
						? SapientInfo.get((LivingEntity) this.getTrueDamager()).getIdentity()
						: null;
	}

	@Override
	public Entity getDoerEntity(ServerWorld worldFrom) {
		return this.trueDamager;
	}
