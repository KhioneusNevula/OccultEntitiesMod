...
public class CitizenAttackDeed extends CitizenDeed {
	...
	private CitizenEntity trueDamager;
	...
	public CitizenAttackDeed(LivingEntity damaged, long time, CitizenEntity damager, DamageSource source,
			float amount) {
		super(OccurrenceType.ATTACK, damager.getIdentity());
	...
	public CitizenAttackDeed(ServerWorld world) {
	...
	public CitizenEntity getTrueDamager() {
		return trueDamager;
	}
	...
	public boolean isSimilarTo(Occurrence other) {
		...
		if (!(other instanceof CitizenAttackDeed))
			return false;
		CitizenAttackDeed c = (CitizenAttackDeed) other;
