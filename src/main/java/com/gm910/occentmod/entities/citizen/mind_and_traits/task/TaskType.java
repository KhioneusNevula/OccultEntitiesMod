...
public class TaskType<M extends LivingEntity, I extends SapientTask<M>> {
	...
	public static final TaskType<CitizenEntity, EatFoodFromInventory> EAT_FOOD_FROM_INVENTORY = new TaskType<>(
			...
			(e) -> new EatFoodFromInventory(e), (e) -> new EatFoodFromInventory());
	...
	public TaskType(Class<M> doerClass, Class<I> taskClass, ResourceLocation rl, Function<Dynamic<?>, I> deserializer,
	...
	@SuppressWarnings("unchecked")
	public static <T extends SapientTask<? extends LivingEntity>> T deserialize(Dynamic<?> d) {
