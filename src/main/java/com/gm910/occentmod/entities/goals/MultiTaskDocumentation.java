...
public class MultiTaskDocumentation<E extends LivingEntity> extends Task<E> {
	...
	protected boolean shouldContinueExecuting(ServerWorld worldIn, E entityIn, long gameTimeIn) {
		return this.field_220419_e.func_220655_b().filter((p_220414_0_) -> {
			...
			return ModReflect.run(Task.class, boolean.class, "shouldContinueExecuting", "func_212834_g_", p_220413_4_,
					new Class[] { ServerWorld.class, LivingEntity.class, long.class },
					new Object[] { worldIn, entityIn, gameTimeIn });
