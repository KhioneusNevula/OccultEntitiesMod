...
public class WorldControllerTESR extends TileEntityRenderer<WorldControllerTileEntity> {
	private static WorldControllerTESR INSTANCE;

	public WorldControllerTESR(TileEntityRendererDispatcher rendererDispatcherIn) {
		super(rendererDispatcherIn);
		INSTANCE = this;
	}

	public static WorldControllerTESR getINSTANCE() {
		return INSTANCE;
	}
