...
public class NeuralNet {
	 ...
	 * 
	 * @param id           Neural network id to be set
	 * @param inputLayer   Neural network input layer to be set
	 * @param hiddenLayers Neural network hidden layers to be set
	 * @param outputLayer  Neural network output layer to be set
	 */
