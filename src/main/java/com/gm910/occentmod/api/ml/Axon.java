...
public class Axon {
	/**
	 * From neuron for this connection (source neuron). This connection is output
	 * connection for from neuron.
	 */
	protected Neuron fromNeuron;
	/**
	 * To neuron for this connection (target, destination neuron) This connection is
	 ...
	 */
	public Axon(Neuron fromNeuron, Neuron toNeuron) {
	 ...
	 */
	public Axon(Neuron fromNeuron, Neuron toNeuron, double weight) {
	...
	/**
	 * Returns input of this connection - the activation function result calculated
	 * in the input neuron of this connection.
	 *
