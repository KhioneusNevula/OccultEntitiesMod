...
public class ModReflect {
	...
	/**
	 * Checks if b is an instanceof the class represented by clazz (or alternatively the first generic type parameter X). Works for generics
	 * @param <X>
	 * @param <M>
	 * @param b
	 * @param clazz
	 ...
	 */
	@SuppressWarnings("unchecked")
	public static <X, M> boolean instanceOf(M b, @Nullable Class<X> clazz) {
		try {
			X r = (X) b;
			return true;
