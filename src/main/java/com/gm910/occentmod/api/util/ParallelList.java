...
public class ParallelList<E, M> extends ArrayList<E> {
	 ...
	 * @param trans1 this is the function that is used to translate the elements of this list to the other list
	...
	public boolean contains(Object o) {
		return basis.contains(ModReflect.<E, Object>instanceOf(o, null) ? translatorEM.apply((E)o) : o);
	}
	...
	public boolean remove(Object o) {
		return basis.remove(ModReflect.<E, Object>instanceOf(o, null) ? translatorEM.apply((E)o) : o);
	}

	@Override
	public boolean containsAll(Collection<?> c) {
		return basis.containsAll( ModReflect.<Collection<E>, Collection<?>>instanceOf(c, null) ? this.translateCollectionEM((Collection<E>) c) : c);
	}
	...
	public boolean removeAll(Collection<?> c) {
		return basis.removeAll( ModReflect.<Collection<E>, Collection<?>>instanceOf(c, null) ? this.translateCollectionEM((Collection<E>) c) : c);
	}

	@Override
	public boolean retainAll(Collection<?> c) {
		return basis.retainAll( ModReflect.<Collection<E>, Collection<?>>instanceOf(c, null) ? this.translateCollectionEM((Collection<E>) c) : c);
	}
	...
	public int indexOf(Object o) {
		return basis.indexOf( ModReflect.<E, Object>instanceOf(o, null) ? translatorEM.apply((E) o) : o);
	}

	@Override
	public int lastIndexOf(Object o) {
		return basis.lastIndexOf( ModReflect.<E, Object>instanceOf(o, null) ? translatorEM.apply((E) o) : o);
	}
