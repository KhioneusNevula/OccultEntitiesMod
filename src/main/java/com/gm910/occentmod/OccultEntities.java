...
import com.gm910.occentmod.api.networking.Sides;
...
import com.gm910.occentmod.init.EntityTypeInit;
...
public class OccultEntities
{
    ...
    private void doClientStuff(final FMLClientSetupEvent event) {
        ...
        ModKeys.clientinit();
        ModChannels.INSTANCE.registerMessage(ModChannels.id++, TaskMessage.class, TaskMessage::encode, TaskMessage::fromBuffer, TaskMessage::handle);
    }

    private void enqueueIMC(final InterModEnqueueEvent event)
    {
        // some example code to dispatch IMC to another mod
        InterModComms.sendTo("occentmod", "helloworld", () -> { LOGGER.info("Hello world from the MDK"); return "Hello world";});
    }
