...
public class MindChunkGenerator extends NoiseChunkGenerator<MindGenSettings> {
	...
	public MindChunkGenerator(IWorld worldIn, BiomeProvider biomeProviderIn, MindGenSettings settingsIn) {
	...
	protected void fillNoiseColumn(double[] noiseColumn, int noiseX, int noiseZ) {
		...
		int i = 64;
		int j = -3000;
		this.calcNoiseColumn(noiseColumn, noiseX, noiseZ, 1368.824D, 684.412D, 17.110300000000002D, 4.277575000000001D,
				64, -3000);
	}
