...
public class SpiritChunkGenerator extends NoiseChunkGenerator<SpiritGenSettings> {
  ...
  public SpiritChunkGenerator(IWorld worldIn, BiomeProvider provider, SpiritGenSettings settingsIn) {
